...
import net.sf.jasperreports.engine.export.tabulator.*;
...
import net.sf.jasperreports.renderers.*;
...
/**
 * @Description: 重写了HtmlExporter类,将一些配置修改
 * @Author: lly
 * @Date: 2019-02-20 10:07
 */
public class OverrideHtmlExporter extends AbstractHtmlExporter<HtmlReportConfiguration, HtmlExporterConfiguration> {
    ...
    public OverrideHtmlExporter()
    {
        this(DefaultJasperReportsContext.getInstance());
    }

    public OverrideHtmlExporter(JasperReportsContext jasperReportsContext)
    {
...
//			String textTooltip = hyperlinkStarted ? null : text.getHyperlinkTooltip();
                            ...
                            if (isEmbeddedSvgUseFonts(imageElement))
                            {
                                ...
                                SvgFontProcessor svgFontProcessor = new SvgFontProcessor(jasperReportsContext, locale)
                                {
                                    ...
                                    public String getFontFamily(String fontFamily, Locale locale)
                                    {
                                        ...
                                        return OverrideHtmlExporter.this.getFontFamily(true, fontFamily, locale);
                                    }
                                };
    ...
    protected class TableVisitor implements CellVisitor<TablePosition, Void, IOException>
    {
        ...
        public Void visit(FrameCell frameCell, TablePosition position) throws IOException
        {
            ...
            OverrideHtmlExporter.this.writeFrameCell(tableCell);
            return null;
        }
                ...
                throws IOException
        {
            ...
            OverrideHtmlExporter.this.writeLayers(layeredCell.getLayers(), this, tableCell);
            return null;
        }
    }
    ...
    protected class ExporterContext extends BaseExporterContext implements JRHtmlExporterContext
    {
        ...
        {
            return OverrideHtmlExporter.this.getHyperlinkURL(link);
        }
    }
