...
public class UserRoleRep extends BaseRep<UserRole, UserRoleMapper>
    ...
    // 更新等 (需要事务)
    @Override
    public String insert(UserRole po, String operUserId, Date operTime) throws Exception{
        // 必填检查
    ...
    @Override
    public void del(String userId, String roleId, String operUserId, Date operTime) throws Exception {
    ...
    // 内部方法
    public void del(List<UserRole> poList, String operUserId, Date operTime) throws Exception {
